...
# Education and learning has no destination but a continuous process. Therefore, I am currently in the final semester of MBA (Final), MTH (Final) and MHRM (Master of Human Resource Management). 
...
%{color:green}MA, MPM, DIRPM (Gold), DTRM, DPM, DIJ, DCL, DLL, DPM (AU), DPM (BIET) CLR & CB (USA - I rank) DIJ. FMC (Gold).IMC (Gold) (MBA) (MTH) DRTM.%
